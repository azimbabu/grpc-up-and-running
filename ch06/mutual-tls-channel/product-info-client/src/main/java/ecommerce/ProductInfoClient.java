...
public class ProductInfoClient {
  ...
  public static void main(String[] args) throws SSLException {
    File caFile = Paths.get("ch06", "mutual-tls-channel", "certs", "ca.crt").toFile();
    File certFile = Paths.get("ch06", "mutual-tls-channel", "certs", "client.crt").toFile();
    File keyFile = Paths.get("ch06", "mutual-tls-channel", "certs", "client.pem").toFile();
