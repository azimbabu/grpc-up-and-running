...
public class OpenTelemetryConfiguration {
  ...
  public static OpenTelemetry initOpenTelemetry() {
    ...
    OtlpGrpcSpanExporter jaegarOtlpExporter =
    ...
    MetricReader prometheusReader =
        PrometheusHttpServer.builder().setPort(getPrometheusPort()).build();
  ...
  private static int getPrometheusPort() {
    return System.getProperties().containsKey(PROMETHEUS_PORT_PROPERTY)
        ? Integer.parseInt(System.getProperty(PROMETHEUS_PORT_PROPERTY))
