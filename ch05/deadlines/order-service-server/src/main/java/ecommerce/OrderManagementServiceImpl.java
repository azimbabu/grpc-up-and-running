...
public class OrderManagementServiceImpl extends OrderManagementGrpc.OrderManagementImplBase {
  ...
  public void addOrder(
    ...
    long sleepingDuration = ThreadLocalRandom.current().nextInt() % 2 == 0 ? 5000 : 0;
    logger.info("Sleeping for duration=" + sleepingDuration + " ms");
    ...
    if (context.getDeadline().isExpired()) {
      logger.info("Cancelling addOrder call from server");
      context.cancel(null);
      return;
    }
